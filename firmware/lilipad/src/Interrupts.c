...
//						SMB0DAT = SMB_DATA_ARRAY[tx_data_index];
						SMB0DAT = SMB_DATA_PTR[tx_data_index];
						tx_data_index++;
					}
				...
				else if (tx_data_index < SMB_DATA_LEN)  // Data TX in progress
				{
					// Send next byte
//					SMB0DAT = SMB_DATA_ARRAY[tx_data_index];
					SMB0DAT = SMB_DATA_PTR[tx_data_index];
