...
C_SRCS += \
$(WCT1013PD_ESCAPED)/USBPD/usb_pd_connect.c \
$(WCT1013PD_ESCAPED)/USBPD/usb_pd_interface.c \
$(WCT1013PD_ESCAPED)/USBPD/usb_pd_msg.c \
$(WCT1013PD_ESCAPED)/USBPD/usb_pd_policy.c \
$(WCT1013PD_ESCAPED)/USBPD/usb_pd_timer.c \
...
Sources/USBPD/usb_pd_connect_c.obj: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_connect.c
	@echo 'Building file: $<'
...
Sources/USBPD/usb_pd_connect_c.d: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_connect.c
	@echo 'Regenerating dependency file: $@'
	
	@echo ' '

Sources/USBPD/usb_pd_interface_c.obj: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_interface.c
	@echo 'Building file: $<'
...
Sources/USBPD/usb_pd_interface_c.d: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_interface.c
	@echo 'Regenerating dependency file: $@'
	
	@echo ' '

Sources/USBPD/usb_pd_msg_c.obj: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_msg.c
	@echo 'Building file: $<'
...
Sources/USBPD/usb_pd_msg_c.d: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_msg.c
	@echo 'Regenerating dependency file: $@'
	
	@echo ' '

Sources/USBPD/usb_pd_policy_c.obj: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_policy.c
	@echo 'Building file: $<'
...
Sources/USBPD/usb_pd_policy_c.d: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_policy.c
	@echo 'Regenerating dependency file: $@'
	
	@echo ' '

Sources/USBPD/usb_pd_timer_c.obj: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_timer.c
	@echo 'Building file: $<'
...
Sources/USBPD/usb_pd_timer_c.d: $(WCT1013PD_ESCAPED)/USBPD/usb_pd_timer.c
	@echo 'Regenerating dependency file: $@'
