...
#ifndef __FREEMASTER_WCT1xxx_H
#define __FREEMASTER_WCT1xxx_H
...
#define FMSTR_IDT_STRING "WCT1xxx FreeMASTER Driver"
...
/* MSCAN functionality tested on WCT1xxx */
#define FMSTR_CANHW_MSCAN 1 

/* FlexCAN functionality tested on WCT1xxx */
