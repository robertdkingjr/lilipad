...
* @file   freemaster.h
*
* @brief  FreeMASTER Driver main API header file, WCT1xxx platform
*
* @version 1.0.17.0
* 
* @date Oct-2-2012
...
#define FMSTR_PLATFORM_WCT1xxx 1
...
typedef unsigned long  FMSTR_ADDR;              /* CPU address type (use integer data type on WCT1xxx) */
